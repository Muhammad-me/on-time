          ...
          <>
            <div className="mx-auto px-2 sm:px-6 lg:px-8">
              <div className="flex items-center justify-between">
                ...
                <div>
                  <button className="justify-between items-center w-40 py-4 px-5 bg-[#D63E0E] active:bg-[#B2330B] rounded-[36px] md:flex hidden">
            ...
            <Disclosure.Panel className="md:hidden text-center">
              <div className="space-y-1 px-2 pt-2 pb-3">
                ...
                <button className="justify-between items-center w-40 py-4 px-5 bg-[#D63E0E] active:bg-[#B2330B] rounded-[36px] md:hidden flex mx-auto">
                  Get in touch <ArrowUp />
                </button>
              </div>
            </Disclosure.Panel>
